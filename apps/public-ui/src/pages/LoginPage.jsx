...
// Simple Google Icon SVG to use in our button
const GoogleIcon = () => (
  // UPDATED: Replaced Tailwind className with inline styles for correct sizing
  <svg style={{ width: '1.5rem', height: '1.5rem', marginRight: '12px' }} viewBox="0 0 48 48">
...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      navigate('/dashboard'); // Using a relative path is fine with HashRouter
    } catch (error) {
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: '#f0f2f5' }}>
